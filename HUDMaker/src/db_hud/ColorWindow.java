...
public class ColorWindow extends Dialog {
	...
	public static Object open() {
		colorUI = new Shell(SWT.BORDER | SWT.CLOSE | SWT.SYSTEM_MODAL);
	...
	colorUI.setImage(HUD_Maker.icon);
		...
		colorPreview.setBackground(SWTResourceManager.getColor(HUD_Maker.cr.ColorR, HUD_Maker.cr.ColorG, HUD_Maker.cr.ColorB));
		scRed.setSelection(HUD_Maker.cr.ColorR);
		scGreen.setSelection(HUD_Maker.cr.ColorG);
		scBlue.setSelection(HUD_Maker.cr.ColorB);
		scAlpha.setSelection(HUD_Maker.cr.ColorA);
		mRed.setText(Integer.toString(HUD_Maker.cr.ColorR));
		mGreen.setText(Integer.toString(HUD_Maker.cr.ColorG));
		mBlue.setText(Integer.toString(HUD_Maker.cr.ColorB));
		mAlpha.setText(Integer.toString(HUD_Maker.cr.ColorA));
	...
	private static void createContents() {
		...
		btnOkay.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent e){
				HUD_Maker.cr.ColorR = R;
				HUD_Maker.cr.ColorG = G;
				HUD_Maker.cr.ColorB = B;
				HUD_Maker.cr.ColorA = A;
				HUD_Maker.colorPreview.setBackground(SWTResourceManager.getColor(R, G, B));
				colorUI.close();
			}
		});
		...
		btnCancel.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent e){
				HUD_Maker.colorPreview.setBackground(SWTResourceManager.getColor(HUD_Maker.cr.ColorR, HUD_Maker.cr.ColorG, HUD_Maker.cr.ColorB));
				R = HUD_Maker.cr.ColorR;
				G = HUD_Maker.cr.ColorG;
				B = HUD_Maker.cr.ColorB;
				A = HUD_Maker.cr.ColorA;
				colorUI.close();
			}
		});
