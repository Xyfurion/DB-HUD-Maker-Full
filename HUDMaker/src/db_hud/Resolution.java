...
public class Resolution extends Dialog {
	...
	private static void createContents() {
		...
		lblNoteThisIs.setFont(SWTResourceManager.getFont("Segoe UI Semibold", 9, SWT.BOLD));
		...
		lblNoteThisIs.setBounds(107, 180, 253, 41);
		lblNoteThisIs.setText("HUD Maker is currently in Beta.\r\nSome features may not yet be complete.");
		btnOkay.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent e){
				...
				else if (combo_res.getText().equals("1920 x 1080")){HUD_Maker.compX = 1920; HUD_Maker.compY = 1080; HUD_Maker.sizeX = 1920; HUD_Maker.sizeY = 1080; HUD_Maker.plusX = 0; HUD_Maker.plusY = 0;}
				...
				else {HUD_Maker.compX = 1280; HUD_Maker.compY = 720; HUD_Maker.plusX = 0; HUD_Maker.plusY = 0;}
